...
$(document).ready(function() { 	
	...
	$('.search-group li').click(function(){
		...
		searchInput.attr("placeholder", $(this).data("prop"));
				...
				prefetch: 'http://123.59.49.58:8080/sm-shop/services/public/search/default/zh/autocomplete.html?q=cck-8',
				remote: {
					url: 'http://123.59.49.58:8080/sm-shop/services/public/search/default/zh/autocomplete.html?q=%QUERY',
					wildcard: '%QUERY'
				}
			});
